...
<script language="javascript" src="ZbglTpJDJK.js"></script><!--提票单列表  -->
<script language="javascript" src="ZbglTpExceptionJDJK.js"></script><!--提票例外放行列表  -->
...
<script language="javascript" src="ZbglRdpJDJKWin.js"></script><!--查看窗口  -->
<script language="javascript" src="ZbglRdpJDJK.js"></script><!--主界面列表  -->
</head>
<body>
</body>
</html>