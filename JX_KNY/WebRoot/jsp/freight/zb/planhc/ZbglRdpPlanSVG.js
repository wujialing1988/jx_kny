 ...
 * 获取车头svg图片
 */
function getHeadImgUrl(title,color,flag){
    ...
    '</svg>';
	if(flag){
		svg = '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="153" height="90" style="background-color:black">' +
	    '<polygon points="0,70 40,20  150,20 150,70" style="stroke:'+color+';stroke-width:5;fill-rule:nonzero;" />' +
	    '<line x1="50" y1="20" x2="50" y2="70" style="stroke:'+color+';stroke-width:5" />' +
	    '<circle cx="50" cy="75" r="13" stroke="'+color+'" stroke-width="3" fill="#9b8885"/>' +
	    '<circle cx="110" cy="75" r="13" stroke="'+color+'" stroke-width="3" fill="#9b8885"/>' +
	    '<text style="fill:white;font-size:12pt;" x="55" y="50">'+title+'</text>'+
	    '</svg>';
	}
...
/**
 * 获取车身svg图片
 * flag : true 显示作业人员 适用于货车列检图
 */
function getBodyImgUrl(title,color,flag,workPersonName){
	
	var svg ;
	if(flag){
		svg ='<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="153" height="90" style="background-color:black">' +
	    '<rect x = "10" y="20" width = "140" height="50" style="stroke:'+color+';stroke-width:5;fill-rule:nonzero;"/>' +
	    '<line x1="0" y1="30" x2="10" y2="30" style="stroke:'+color+';stroke-width:5" />' +
	    '<line x1="0" y1="60" x2="10" y2="60" style="stroke:'+color+';stroke-width:5" />' +
	    '<line x1="50" y1="20" x2="50" y2="70" style="stroke:'+color+';stroke-width:5" />' +
	    '<circle cx="50" cy="75" r="13" stroke="'+color+'" stroke-width="3" fill="#9b8885"/>' +
	    '<circle cx="110" cy="75" r="13" stroke="'+color+'" stroke-width="3" fill="#9b8885"/>' +
	    '<text style="fill:white;font-size:12pt;" x="55" y="50">'+title+'</text>'+
	    '<text style="fill:white;font-size:12pt;" x="12" y="13">'+workPersonName+'</text>'+
	    '</svg>';
	}else{
