...
<script language="javascript" src="<%=ctx%>/jsp/freight/zb/gztp/ZbglRdpPlanRecord.js"></script> <!-- 车辆列表 -->
<script language="javascript" src="<%=ctx%>/jsp/freight/zb/gztp/ZbglRdpPlan.js"></script> <!-- 列检计划列表 -->
<script language="javascript" src="<%=ctx%>/jsp/freight/zb/gztp/Gztp.js"></script> <!-- 主布局 -->
</head>
<body>
</body>
</html>
