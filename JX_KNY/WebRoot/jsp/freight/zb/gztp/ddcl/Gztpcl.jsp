...
<script language="javascript" src="<%=ctx%>/jsp/freight/zb/gztp/ddcl/GztpclTicket.js"></script> <!-- 故障提票(调度处理)列表 -->
<script language="javascript" src="<%=ctx%>/jsp/freight/zb/gztp/ddcl/Gztpcl.js"></script> <!-- 主布局 -->
</head>
<body>
</body>
</html>
