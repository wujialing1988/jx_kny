...
Object.prototype["Aggregate"] = function (func: Function, thisArg: Object)
{
    if (this instanceof Array || this instanceof String)
    {
        ...
        this.ForEach((i, j) =>
        {
            ...
            {
                workingSentence = i;
                workingSentence = func.call(thisArg, workingSentence, this[j + 1]);
...
Object.prototype["AggregateSeed"] = function (seed: any, func: Function, thisArg: Object)
{
...
Object.prototype["All"] = function (func: Function, thisArg: Object)
{
    var Return = false;
    var result = true;
    this.ForEach((i, j) =>
...
{
    var result = false;
    this.ForEach((i, j) => { result = true; });
    return result;

}
Object.prototype["Contains"] = function (Value: any)
{
    var result = false;
    this.ForEach((i, j) =>
    {
...
Object.prototype["Count"] = function (func: Function, thisArg: Object)
{
    if (func == undefined)
    {
        if (this instanceof Array || this instanceof String)
...
Object.prototype["DefaultIfEmpty"] = function (Value: any)
{
    var array = new Array();
    this.ForEach((i, j) => { array.push(i) });
    if (array.length > 0)
    {
        return array;
    }
...
Array.prototype["Distinct"] = function (Comparer: Function)
{
    if (Comparer == undefined)
    {
        Comparer = (i) => { return i.GetHashCode(); };
    }
...
Object.prototype["ElementAt"] = function (index: Number)
{
...
Object.prototype["Except"] = function (arr: any, Comparer: Function)
{
    if (Comparer == undefined)
    {
        Comparer = (i) => { return i.GetHashCode(); };
...
Object.prototype["ElementAtOrDefault"] = function (index: Number, Value: any)
{
...
Object.prototype["ForEach"] = function (func: Function, thisArg: Object)
{
    if (this instanceof Array || this instanceof String)
    {
        if (this.forEach)
...
Object.prototype["First"] = function (Comparer: Function)
{
    if (Comparer == undefined)
    {
        Comparer = (i) => { return i === i; };
    }
    else if (typeof Comparer != "function")
    {
        throw new Error("回调必须为函数,且必须有返回值(返回需要对比数据的HashCode),返回值类型为int");
...
Object.prototype["FirstOrDefault"] = function (value: any, Comparer: Function)
{
...
Object.prototype["Intersect"] = function (arr: any, Comparer: Function)
{
    if (Comparer == undefined)
    {
        Comparer = (i) => { return i.GetHashCode(); };
...
Object.prototype["Union"] = function (arr: any, Comparer: Function)
{
    if (Comparer == undefined)
    {
        Comparer = (i) => { return i.GetHashCode(); };
...
Object.prototype["GroupBy"] = function (keySelector: Function, elementSelector: Function)
{
    ...
    var arr = new Array();
    HashCodeArr["ForEach"]((i, j) =>
    {
        arr.push(i[1]);
    });
    return arr;
}
Object.prototype["Skip"] = function (Count: any) 
{
...
Object.prototype["Take"] = function (Count: Number)
{
    if (this instanceof Array)
    {
        var array = new Array();
...
Object.prototype["Last"] = function (Comparer: Function)
{
    if (Comparer == undefined)
    {
        Comparer = (i) => { return i === i; };
...
Object.prototype["LastOrDefault"] = function (value: any, Comparer: Function)
{
...
Object.prototype["GroupJoin"] = function (inner: any, outerKeySelector: Function, innerKeySelector: Function, resultSelector: Function)
{
    if (inner == undefined)
    {
...
Object.prototype["Concat"] = function (second: any)
{
    if (second == undefined)
    {
        throw new Error("用于连接的参数不能为空");
...
Object.prototype["SkipWhile"] = function (Count: any, func: Function, thisArg: Object)
{
    if (func == undefined)
    {
        if (this instanceof Array || this instanceof String)
...
Object.prototype["TakeWhile"] = function (Count: any, func: Function, thisArg: Object)
{
    if (func == undefined)
    {
        if (this instanceof Array || this instanceof String)
...
Object.prototype["Repeat"] = function (Element: Number, Count: Number)
{
    if (this instanceof Array)
    {
        var array = new Array();
...
Object.prototype["Where"] = function(func: Function, thisArg: Object) 
{
    if (this instanceof Array)
    {
        var array = new Array();
...
Array.prototype["OrderBy"] = function (fun: Function, thisArg: Object)
{
    if (fun == undefined)
    {
        fun = (i) => { return i.GetHashCode(); };
    }
...
Array.prototype["OrderByDescending"] = function (fun: Function, thisArg: Object)
{
    if (fun == undefined)
    {
        fun = (i) => { return i.GetHashCode(); };
...
Object.prototype["Join"] = function (inner: any, outerKeySelector: Function, innerKeySelector: Function, resultSelector: Function)
{
    if (inner == undefined)
    {
        throw new Error("用于连接的参数不能为空");
