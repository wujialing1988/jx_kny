...
alpha:C和A的夹角角度
*/
Object.prototype["GetC"] = function (A, B, L2, Alpha) {
...
Slope:原始线的斜率
*/
Object.prototype["GetSlope1"] = function (Slope) {
    return -1 / Slope;
};
/*
取一条线段的斜率
...
B:线段B点坐标
*/
Object.prototype["GetSlope"] = function (A, B) {
...
F:两点之间的距离
*/
Object.prototype["GetPath"] = function (P, S, F) {
    var List = new Array();
    if (S == 0) {
        S = 1E-20;
    }
    ...
    var x = y / S;
    var PointA = document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGPoint();
    PointA.x = P.x - x;
    PointA.y = P.y - y;
    var PointB = document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGPoint();
    PointB.x = P.x + x;
    PointB.y = P.y + y;
    List.push(PointA);
    List.push(PointB);
...
F:两点之间的距离
*/
Object.prototype["GetPath1"] = function (P, S, F) {
    var List = new Array();
    if (S == 0) {
        S = 1E-20;
    }
...
B:B点坐标
*/
Object.prototype["GetDistance"] = function (A, B) {
...
B:移动点
*/
Object.prototype["GetCentralPoint"] = function (A, B) {
...
B:线段B点坐标
*/
Object.prototype["CentralPoint"] = function (A, B) {
    var Point = document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGPoint();
    Point.x = (A.x + B.x) / 2;
    Point.y = (A.y + B.y) / 2;
    return Point;
...
生成SVGPoint
*/
Object.prototype["ParsePoint"] = function (Value) {
    var Point = document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGPoint();
    var str = Value.split(',');
    var p1 = 0;
    var p2 = 0;
