...
<script language="javascript" src="<%= ctx %>/jsp/twt/twtinfo/SiteViedoNvrImport.js"></script>
<script language="javascript" src="<%= ctx %>/jsp/twt/twtinfo/SiteVideoNvrChanel.js"></script>
<script language="javascript" src="<%= ctx %>/jsp/twt/twtinfo/SiteVideoNvrConfig.js"></script>
