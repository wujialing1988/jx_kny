...
Ext.onReady(function(){
	...
	PartsIntegrateQuery.searchForm = new Ext.form.FormPanel({
		...
		items: [{
			...
			items: [{
				 id:"trainType_comb",xtype: "TrainType_combo",	fieldLabel: "车型", hiddenName: "unloadTrainTypeIdx", anchor:'90%',
				  returnField: [{widgetId:"PartsUnloadRegister_unloadTrainType",propertyName:"shortName"}],
				  displayField: "shortName", valueField: "typeID",
				  pageSize: 20, minListWidth: 150,   //isCx:'no',
				  editable:false 	                    
//			}, {
//				id:"PartsUnloadRegister_unloadTrainType",xtype:"hidden", name:"unloadTrainType"
			...
			items: [{
		    	xtype:"checkbox", name:"byQty",id:"status", boxLabel:"不显示保有量为0的记录&nbsp;&nbsp;&nbsp;&nbsp;", checked: true,
		    	handler:function(){
		    		// 清空数据集			
	...
	PartsIntegrateQuery.grid = new Ext.yunda.Grid({
		...
		fields: [{
			...
			header:'保有量', dataIndex:'byQty', width: PartsIntegrateQuery.gridWidth,
