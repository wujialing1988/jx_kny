...
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/planmanage/MatPlanDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/planmanage/MatPlan.js"></script>
<script type="text/javascript">
