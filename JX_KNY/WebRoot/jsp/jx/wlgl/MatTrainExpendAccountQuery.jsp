...
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/MatTrainExpendAccountQuery.js"></script>
<script type="text/javascript">
	...
	var DATA_SOURCE = '<%= MatTrainExpendAccount.CONST_STR_DATASOURCE_OUTWH %>'			// 数据来源
</script>
</head>
<body>
</body>
