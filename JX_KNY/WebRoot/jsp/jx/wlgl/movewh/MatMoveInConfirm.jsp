...
<script language="javascript" src="<%=ctx%>/jsp/jx/wlgl/movewh/SplinMoveInWin.js"></script> 
<script language="javascript" src="<%=ctx%>/jsp/jx/wlgl/movewh/MatMoveInConfirm.js"></script> 
