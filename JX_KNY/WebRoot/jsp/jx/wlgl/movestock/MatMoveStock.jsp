...
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/movestock/MatMoveStockDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/movestock/MatMoveStock.js"></script>
<script type="text/javascript">
