...
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/instock/MatInWhQueryDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/instock/MatInWhQuery.js"></script>
