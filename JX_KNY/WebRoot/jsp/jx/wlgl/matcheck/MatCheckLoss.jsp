...
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/matcheck/MatCheckLossDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/matcheck/MatCheckLoss.js"></script>
<script type="text/javascript">
