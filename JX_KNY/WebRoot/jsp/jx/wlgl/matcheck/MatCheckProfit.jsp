...
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/matcheck/MatCheckProfitDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/matcheck/MatCheckProfit.js"></script>
<script type="text/javascript">
