...
<title>物料盘盈处理查询</title>
<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/pjwz/BaseCombo.js"></script> 
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/matcheck/MatCheckProfitQueryDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/matcheck/MatCheckProfitQuery.js"></script>
