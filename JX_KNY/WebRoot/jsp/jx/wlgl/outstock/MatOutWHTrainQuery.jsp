...
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/outstock/MatOutWHTrainQueryDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/wlgl/outstock/MatOutWHTrainQuery.js"></script>
