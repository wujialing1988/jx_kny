...
Ext.namespace('JobProcessLeafNodeSearch');                       //定义命名空间
JobProcessLeafNodeSearch.labelWidth = 90;
JobProcessLeafNodeSearch.fieldWidth = 150;
JobProcessLeafNodeSearch.idx = '';
JobProcessLeafNodeSearch.nodeIDX = '';
JobProcessLeafNodeSearch.workPlanIDX = '';
JobProcessLeafNodeSearch.processIDX = '';
JobProcessLeafNodeSearch.parentIDX = '';
JobProcessLeafNodeSearch.planBeginTime = null;
JobProcessLeafNodeSearch.workstationReturnFn = function(stationObject) {
	var form = JobProcessLeafNodeSearch.form;
...
JobProcessLeafNodeSearch.form = new Ext.form.FormPanel({
    baseCls: "x-plain", align: "center",	defaultType: "textfield",
	layout: "form",		border: false,	labelWidth: JobProcessLeafNodeSearch.labelWidth,
    defaults: {
    	anchor: "95%",
    	defaults: {
    		defaults:{
    			xtype:"textfield", 
			    labelWidth:JobProcessLeafNodeSearch.labelWidth, anchor:"98%",
			    defaults: {
			    	width: JobProcessLeafNodeSearch.fieldWidth
			    }
    		}    		
    	}
    },
    items: [{
    	...
    	items:[{
				baseCls:"x-plain", align:"center", layout:"form", labelWidth:JobProcessLeafNodeSearch.labelWidth, columnWidth: 0.5,
		    	items:[{
		    	...
		    	items:[{
		    			...
		    			xtype: 'JobNodeStationDefSelect', nodeIDX: JobProcessLeafNodeSearch.nodeIDX,
						editable: false, returnFn: JobProcessLeafNodeSearch.workstationReturnFn, disabled: true
...
//			  		   selectNodeModel: 'leaf', width: 170
		    			...
		    			name: 'idx', value: JobProcessLeafNodeSearch.idx , xtype:"hidden"
		    		},{
		    			name: 'workPlanIDX', xtype:"hidden"
		    		},{
		    			name: 'processIDX',  xtype:"hidden"
		    		},{
		    			name: 'parentIDX', value: JobProcessLeafNodeSearch.parentIDX , xtype:"hidden"
		    		},{
