...
<script type="text/javascript">
	var  timelineWindowsLen = <%=SystemConfigUtil.getValue("ck.timeline.len")%> ;
	var  timelineNodeLen = <%=SystemConfigUtil.getValue("ck.timeline.nodelen")%> ;
	...
	/* 父节点未开工，未处理显示样式定义 */
	var status_wkg = "color: #FFF;background-color: #999999; border-color: black;";
	/* 已开工，处理中显示样式定义 */
	var status_ykg = "color: #FFF;background-color: #fec80c; border-color: black;";
	
	/* 已延期显示样式定义 */
	var status_yyq = "color: #FFF;background-color: #ff0000;border-color: black;";
	
	/* 已完工,已处理显示样式定义 */
	var status_ywg = "color: #FFF;background-color: #008000;border-color: black;";
...
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/workplanmanage/JobNodeExtConfigSearch.js"></script><!-- 扩展配置查看窗口-->
...
<script language="javascript" src="<%= ctx %>/jsp/jx/jxgc/workplanmanage/trainworkplanLeafnode/TrainWorkPlanForEditLeafNode.js"></script>
<script language="javascript" src="<%= ctx %>/jsp/jx/jxgc/workplanmanage/trainworkplanLeafnode/TrainWorkPlanForLeafNode.js"></script>
<script language="javascript" src="<%= ctx %>/jsp/jx/jxgc/workplanmanage/trainworkplanLeafnode/TrainWorkPlanRecords.js"></script>
