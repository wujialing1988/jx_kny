...
<script type="text/javascript">
	...
	var  timelineNodeLen = <%=SystemConfigUtil.getValue("ck.timeline.nodelen")%> ; // 时间轴显示
...
<!-- 超链接页面 -->
<script language="javascript" src="<%= ctx %>/jsp/jx/jxgc/workplanmanage/trainworkplannew/NodeCaseApplyConfirm.js"></script> <!-- 确认申请主页面窗口 -->
...
<script language="javascript" src="<%= ctx %>/jsp/jx/jxgc/workplanmanage/trainworkplannew/JobProcessFirstNodeApplyWin.js"></script>
...
<script language="javascript" src="<%= ctx %>/jsp/jx/jxgc/workplanmanage/trainworkplannew/TrainWorkPlanGantWinNew.js"></script>
<script language="javascript" src="TrainWorkPlanForFirstNode.js"></script>
