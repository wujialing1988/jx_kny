...
JobProcessNodeEditWin.form = new Ext.form.FormPanel({
    ...
    items: [{
    	...
    	items:[{
				...
				baseCls:"x-plain", align:"center", layout:"form", labelWidth:JobProcessNodeEditWin.labelWidth, columnWidth: 0.5,
		    	items:[{
		    			id: 'startDate', name: "planBeginTime", fieldLabel: "开始时间",  xtype:"my97date",format: "Y-m-d H:i",
			        	my97cfg: {dateFmt:"yyyy-MM-dd HH:mm"}, allowBlank:false,  vtype:'dateRange',
				...
				baseCls:"x-plain", align:"center", layout:"form", labelWidth:JobProcessNodeEditWin.labelWidth, columnWidth: 0.5,
		    	items:[{
		    			id:'endDate', name: "planEndTime", fieldLabel: "结束时间",  xtype:"my97date",format: "Y-m-d H:i",
			        	my97cfg: {dateFmt:"yyyy-MM-dd HH:mm"}, vtype:'dateRange', allowBlank:false,
						dateRange:{startDate: 'startDate', endDate: 'endDate'}//, disabled: true, initNow: false
		    		},{
