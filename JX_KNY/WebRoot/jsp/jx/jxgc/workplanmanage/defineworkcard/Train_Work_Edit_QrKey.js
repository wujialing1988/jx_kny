		    ...
		    items: [{
		        ...
		        items: [
		        {
		            ...
		            items: [
		                ...
		                { fieldLabel:"status", name:"status", xtype: "hidden", value: TrainWork.status},
...
//		                { xtype: 'compositefield', fieldLabel : '零部件型号', combineErrors: false, anchor: "100%",
//		    				items:[{
//		    					id: 'PartsTypeByBuild_SelectWin_Id', xtype: 'PartsBuild_SelectWin', 
//							    hiddenName: 'buildUpTypeIDX', 
//							    valueField: 'buildUpTypeIdx', displayField: 'buildUpTypeDesc',			    
//							    editable: false, width: 124,
//							    returnField: [{widgetId: "buildUpTypeName", propertyName: "buildUpTypeName"},
//		    				    			  {widgetId: "fixPlaceFullCode", propertyName: "buildUpPlaceFullCode"},
//		    				    			  {widgetId: "fixPlaceFullName", propertyName: "buildUpPlaceFullName"},
//		    				    			  {widgetId: "fixPlaceIDX", propertyName: "buildUpPlaceIdx"},
//		    				    			  {widgetId: "isVirtual_Id", propertyName: "isVirtual"}],
//							    listeners: {
//									"select" : function(records){				
//				    					TrainWork.PartsPaths = records; 
//									}
//							    }
//		    				},{
//		    					xtype: 'button',
...
//		    	                	Ext.getCmp("fixPlaceIdx_id").setValue("");
//		    	                	
//		    	           	    }
//		    				}]
//		    			},
...
//		});
	...
	TrainWork.showEditWin = function(record){
		...
		WorkStepEdit.clearQC();
		WorkStepEdit.SetWorkSeqQC(record.get("idx"), WorkCardEdit.grid);
...
//		Ext.getCmp("PartsTypeByBuild_SelectWin_Id").setDisplayValue(record.get("buildUpTypeIDX"), record.get("buildUpTypeName"));
	...
	TrainWork.save = function(){
		...
		//判断分类是否选择
		if(!data.workSeqClass){
			MyExt.Msg.alert("请选择分类类型!");
			return;
		}

        delete data.isVirtual;
        
        var qualityForm = WorkStepEdit.saveForm.getForm(); //获取质量检查表单
        ...
        var cfg = {
            ...
            jsonData: data,
            params: {qualityControls: Ext.util.JSON.encode(objs)},
            success: function(response, options){ 
