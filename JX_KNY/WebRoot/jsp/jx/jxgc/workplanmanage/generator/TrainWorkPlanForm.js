...
TrainWorkPlanForm.win = new Ext.Window({
    title:"柴油发电机组检修作业计划", width: (TrainWorkPlanForm.labelWidth + TrainWorkPlanForm.fieldWidth + 8) * 2 + 60,
	        ...
	        var cfg = {
	            ...
	            success: function(response, options){
	                ...
	                if (result.errMsg == null && entity != null) {
						...
						else if(!(typeof(TrainWorkPlanWinForTS)=="undefined")){
		                   TrainWorkPlanWinForTS.showWin(args.join(","));
		                   TrainWorkPlanEdit.store.reload();
	                    } else{
