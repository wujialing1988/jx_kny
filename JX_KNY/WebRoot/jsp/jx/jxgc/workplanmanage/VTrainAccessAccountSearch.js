	...
	VTrainAccessAccount.editForm = new Ext.form.FormPanel({
		...
		items:[{		    	
	    	items:[{
				...
				selectNodeModel: 'leaf', disabled: true
    		},{
    			fieldLabel: "入段时间", name: "inTime", xtype: 'my97date', my97cfg: {dateFmt:'yyyy-MM-dd HH:mm:ss'}, initNow: false, disabled: true
    		},{
    			fieldLabel: "入段司机", name: "inDriver", maxLength:20, disabled: true
    		},{
    			fieldLabel: "计划车次", name: "planOrder", maxLength:20, disabled: true
    		}]
		},{    	
	    	items:[{
				id:"trainNo_comb_Id",	
    			...
    			fieldLabel: "到达车次", name: "arriveOrder", maxLength:20, disabled: true
    		},{
    			fieldLabel: "计划出段时间", name: "planOutTime", xtype: 'my97date', my97cfg: {dateFmt:'yyyy-MM-dd HH:mm:ss'}, initNow: false, disabled: true
    		},{
