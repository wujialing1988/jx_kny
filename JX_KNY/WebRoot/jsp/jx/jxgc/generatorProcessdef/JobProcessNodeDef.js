	...
	JobProcessNodeDef.saveForm = new Ext.form.FormPanel({
		...
		items:[{
			...
			items:[{
				...
				xtype: 'compositefield', fieldLabel: '额定工期', combineErrors: false, allowBlank:true,
				items: [{
...
/*			                { boxLabel: '定时',inputValue: PLANMODE_TIMER, name: 'planMode', checked: true
	...
	JobProcessNodeDef.grid = new Ext.yunda.Grid({
		...
		fields: [{
			...
			header:'额定工期(分钟)', dataIndex:'ratedWorkMinutes', width: 120, editor:{ xtype:'numberfield', maxLength:12 }, 
