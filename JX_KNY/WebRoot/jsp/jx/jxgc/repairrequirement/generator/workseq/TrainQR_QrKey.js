...
//	    viewConfig: null,
		...
		fields: [{
			...
			header:'检修机组型号', dataIndex:'pTrainTypeIDX', hidden: true, 
			editor:{  
				id:"trainType_comb",xtype: "Base_combo",	fieldLabel: "检修机组型号",
				business: 'trainType',													
			...
			header:'机组型号', dataIndex:'pTrainTypeShortName', editor:{id: 'trainTypeShortName_Id', xtype: 'hidden' },
