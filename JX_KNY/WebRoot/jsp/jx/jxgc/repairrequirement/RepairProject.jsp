...
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/repairrequirement/RepairProjectEdit.js"></script> <!-- 检修项目编辑页面操作 -->

<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/repairrequirement/WorkSeqSelect.js"></script><!-- 检修工单选择 -->
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/repairrequirement/RPToWS.js"></script><!-- 检修项目作业工单 -->
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/repairrequirement/RepairProject.js"></script><!-- 机车检修项目 -->
</head>
<body>
</body>
</html>
