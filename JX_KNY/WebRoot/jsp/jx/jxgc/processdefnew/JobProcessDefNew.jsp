...
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/RPToWS.js"></script> <!-- 作业工单查看 -->
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobProcessNodeDefWin.js"></script>
<script language="javascript" src="<%=ctx%>/frame/resources/jquery/jquery.js"></script>
...
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobProcessGantt.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/WorkSeqSearcher.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/RepairLine.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/WorkStationSearcher.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/WorkStation.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobNodeExtConfigDef.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/pjjx/base/wpdefine/MatInforList.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobNodeMatDef.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobProcessNodeRelDef.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdefnew/JobProcessNodeDefNew.js"></script>

<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobProcessPartsOffList.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdefnew/JobProcessDefNew.js"></script>
