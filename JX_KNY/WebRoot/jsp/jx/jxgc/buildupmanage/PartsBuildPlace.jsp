...
<script language="javascript">
	...
	var type = '';//组成类型全局变量	
	var partsStatus_use = <%=PartsType.STATUS_USE%>;//配件启用状态	
	var pageType = 2;//页面类型-2表示是配件组成维护
...
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/buildupmanage/PartsPlaceBuildUp.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/buildupmanage/VirtualPlaceBuildUp.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/buildupmanage/PartsBuildPlace.js"></script>
</head> 
<body>
</body>
</html>
