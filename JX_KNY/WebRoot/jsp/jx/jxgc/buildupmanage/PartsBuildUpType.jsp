...
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/buildupmanage/UpdatePartsBuild.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/buildupmanage/PartsBuildUpType.js"></script>
</head>
<body>
</body>
</html>
