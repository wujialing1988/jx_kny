...
TrainPlaceBuildUp.structurePlaceForm = new Ext.form.FormPanel({
    ...
    buttons:[{
        ...
        handler:function(){
        	//表单验证是否通过
	        var form = TrainPlaceBuildUp.structurePlaceForm.getForm(); 
    	...
    	items : [
    		{
            	...
            	items : [
            		...
            		{ name: "chartNo", fieldLabel: "图号",  width: TrainPlaceBuildUp.fieldWidth, maxLength:50  },
            		{ 
            		...
            		{ name: "buildUpPlaceSEQ", fieldLabel:"序号", maxLength: 8, xtype:"numberfield", vtype: "nonNegativeInt", width: TrainPlaceBuildUp.fieldWidth} 
            	]
    		},
    		{
    			baseCls: "x-plain", align: "center", layout: "form", columnWidth: 0.5, defaultType: "textfield",
            	items : [
            		{ id: "fixPlaceName_SId", name: "buildUpPlaceName", fieldLabel: "结构位置名称", allowBlank: false, width: TrainPlaceBuildUp.fieldWidth, maxLength: 50 },
            		{ name: "buildUpPlaceShortName", fieldLabel: "结构位置简称",  width: TrainPlaceBuildUp.fieldWidth, maxLength:20  },
            		{ id: "partID_form_SId", xtype: "Base_combo",	fieldLabel: "位置",
						  ...
						  pageSize: 20, minListWidth: 200, width: TrainPlaceBuildUp.fieldWidth, editable: true },
...
TrainPlaceBuildUp.partsPlaceForm = new Ext.form.FormPanel({
    ...
    buttons:[{
        ...
        handler:function(){
        	//表单验证是否通过
	        var form = TrainPlaceBuildUp.partsPlaceForm.getForm(); 
	        if (!form.isValid()) return; 
    	...
    	items : [
    		{
    			baseCls: "x-plain", align: "center", layout: "form", columnWidth: 0.5, defaultType: "textfield",
            	items : [
            		{ id: "BuildUpPlace_Code", name: "buildUpPlaceCode", fieldLabel: "配件位置编码", allowBlank: false, disabled:true, width: TrainPlaceBuildUp.fieldWidth, maxLength:10  },
            		{ name: "chartNo", fieldLabel: "图号",  width: TrainPlaceBuildUp.fieldWidth  },
            		{ 
    		...
    		},
    		{
    			baseCls: "x-plain", align: "center", layout: "form", columnWidth: 0.5, defaultType: "textfield",
            	items : [
            		{ id: "BuildUpPlace_Name", name: "buildUpPlaceName", fieldLabel: "配件位置名称", width: TrainPlaceBuildUp.fieldWidth},
            		{ name: "buildUpPlaceShortName", fieldLabel: "配件位置简称", width: TrainPlaceBuildUp.fieldWidth },
...
TrainPlaceBuildUp.virtualPlaceForm = new Ext.form.FormPanel({
    ...
    buttons:[{
        ...
        handler:function(){
        	//表单验证是否通过
	        var form = TrainPlaceBuildUp.virtualPlaceForm.getForm(); 
	        if (!form.isValid()) return; 
    	...
    	items : [
    		{
    			baseCls: "x-plain", align: "center", layout: "form", columnWidth: 0.5, defaultType: "textfield",
            	items : [
            		{ id: "v_BuildUpPlace_Code", name: "buildUpPlaceCode", fieldLabel: "虚拟位置编码", allowBlank: false, disabled:true, width: TrainPlaceBuildUp.fieldWidth, maxLength:10  },
            		{ name: "chartNo", fieldLabel: "图号",  width: TrainPlaceBuildUp.fieldWidth  },
            		{ 
    		...
    		},
    		{
    			baseCls: "x-plain", align: "center", layout: "form", columnWidth: 0.5, defaultType: "textfield",
            	items : [
            		{ id: "v_BuildUpPlace_Name", name: "buildUpPlaceName", fieldLabel: "虚拟位置名称", width: TrainPlaceBuildUp.fieldWidth},
            		{ name: "buildUpPlaceShortName", fieldLabel: "虚拟位置简称", width: TrainPlaceBuildUp.fieldWidth },
...
TrainPlaceBuildUp.childTrainFixGrid =  new Ext.yunda.Grid({
    ...
    tbar: [{
    	text : "选择安装位置",
		iconCls : "addIcon",
		id : "selectPlace_Button",
		handler : function(){
			TrainPlaceBuildUp.buildUpPlaceWin.show();
			//选择安装位置列表加载数据        			
			BuildUpPlace.loadGrid(BuildUpPlace.selectGrid,buildUpTypeIdx);
		}    
    },{
    	text : "新增配件位置",
		iconCls : "addIcon",
...
TrainPlaceBuildUp.win =  new Ext.Window({
    title: "机车组成维护", maximizable: true, width: 705, height: 400, layout: "fit", plain: true, closeAction: "hide",buttonAlign: 'center',
