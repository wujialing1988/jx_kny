...
RQWorkTask.grid = new Ext.yunda.Grid({
    loadURL: ctx + '/workTaskHis!pageList.action',                 //装载列表数据的请求URL
	    deleteURL: ctx + '/workTaskHis!logicDelete.action',
	    saveURL: ctx + '/workTaskHis!saveOrUpdate.action',             //保存数据的请求URL
	    saveFormColNum:2,
	    labelWidth: 120,
	    storeAutoLoad: false,
	    fieldWidth: 240,
