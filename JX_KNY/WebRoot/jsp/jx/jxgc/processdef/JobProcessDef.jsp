...
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobProcessNodeDef.js"></script>

<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobProcessPartsOffList.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/jxgc/processdef/JobProcessDef.js"></script>
