...
Factory_store = new Ext.data.JsonStore({
	url : ctx + "/partsOutSourcingFactory!OutSourcingFactoryList.action",
	autoLoad : true,
	root : "root",
	remoteSort : true,
	totalProperty : "totalProperty",
	fields : [ "id","factoryName","factoryShortname"]
});
//分页工具
	...
	constructor : function() {
		Factory_List.superclass.constructor.call(this, {
			...
			colModel : new Ext.grid.ColumnModel([
				...
				{ sortable:true, header:"委外厂家编号", dataIndex:"id" },			
		        { sortable:true, header:"委外厂家名称", dataIndex:"factoryName" }]),
			store : Factory_store,
...
/** ****************************************************************************************** */
OutSourcing_Factory_Select = Ext.extend(Ext.form.TriggerField, {
	valueField : 'id',
	...
	initComponent : function() {
		OutSourcing_Factory_Select.superclass.initComponent.call(this);
	},
	...
	onRender : function(ct, position) {				
		...
		OutSourcing_Factory_Select.superclass.onRender.call(this, ct, position);
		if (this.hiddenName) {
	...
	initValue : function() {
		OutSourcing_Factory_Select.superclass.initValue.call(this);
		if (this.hiddenField) {
	...
	constructor : function(options) {
		...
		OutSourcing_Factory_Select.superclass.constructor.call(this);
...
//		this.setReturnValue(r);
	...
	getName : function() {
		...
		return hf && hf.name ? hf.name : this.hiddenName
				|| OutSourcing_Factory_Select.superclass.getName.call(this);
	},			
	//获取返回值			
	getValue : function() {				
	...
	setValue : function(r) {				
		...
		{					
			...
			OutSourcing_Factory_Select.superclass.setValue.call(this, r.get("factoryName"));
    ...
    setDisplayValue : function(id, madeFactoryName){
    	var node = {id: id, factoryName: madeFactoryName}; 
    	var p_record = new Ext.data.Record(node);
        this.setValue(p_record);
    },
    //清空(new)
    clearValue :  function(){
    	var node = {id: "", factoryName: ""};
    	var p_record = new Ext.data.Record(node);
		this.setValue(p_record);
    }
});
Ext.reg('PartsOutSourcingFactory_SelectWin', OutSourcing_Factory_Select);