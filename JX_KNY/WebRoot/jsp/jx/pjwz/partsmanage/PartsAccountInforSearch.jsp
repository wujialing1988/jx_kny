...
<script language="javascript" src="<%=ctx%>/jsp/jx/pjwz/partsmanage/PartsRdpDetailInfo.js"></script>
...
<script language="javascript" src="<%=ctx %>/jsp/jx/pjwz/partsmanage/PartsAccountInforSearch.js"></script>
