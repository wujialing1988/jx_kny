...
<script language="javascript" src="<%=ctx %>/jsp/jx/pjwz/fixparts/PartsFixRegisterDetail.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/pjwz/fixparts/PartsFixRegister.js"></script>
</head>
<body>
</body>
</html>
