...
<title>下车配件登记单</title>
	...
	<script language="javascript" src="<%=ctx %>/jsp/jx/pjwz/unloadparts/PartsUnloadRegisterDetail.js"></script>
	<script language="javascript" src="<%=ctx %>/jsp/jx/pjwz/unloadparts/PartsUnloadRegister.js"></script>
</head>
<body>
</body>
</html>
