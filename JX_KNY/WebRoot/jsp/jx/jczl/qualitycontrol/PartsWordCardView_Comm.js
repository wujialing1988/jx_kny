    ...
    items: [{
        ...
        items: [
        {
            ...
            items: [
        		...
        		{ fieldLabel:"开始时间", name:"realBeginTime", width:150, style:"border:none;background:none;", readOnly:true},
            ...
            items: [
                ...
                { fieldLabel:"结束时间", name:"realEndTime", width:150, style:"border:none;background:none;", readOnly:true}
            ]
        },{
            baseCls:"x-plain", align:"center", layout:"form", defaultType:"textfield", labelWidth:80,
            columnWidth: 0.33, 
...
RQWorkCard.layoutPanel = new Ext.Panel({
	...
	items:[{
        ...
        collapsible:true, height: 102, bodyBorder: false,
