    ...
    items: [{
        ...
        items: [
        {
            ...
            items: [
        		...
        		{ fieldLabel:"计划开始时间", name:"planBeginTime", width:150, style:"border:none;background:none;", readOnly:true}
            ]
        },                {
            baseCls:"x-plain", align:"center", layout:"form", defaultType:"textfield", labelWidth:80,
            columnWidth: 0.33, 
            items: [
                ...
                { fieldLabel:"计划完成时间", name:"planEndTime", width:150, style:"border:none;background:none;", readOnly:true}
            ]
        }/*,{
            baseCls:"x-plain", align:"center", layout:"form", defaultType:"textfield", labelWidth:80,
            columnWidth: 0.33, 
    ...
    items: [{
		...
		RQWorkCard.layoutPanel = new Ext.Panel({
			...
			items:[{
		        ...
		        collapsible:true, height: 110, bodyBorder: true,width:300,
