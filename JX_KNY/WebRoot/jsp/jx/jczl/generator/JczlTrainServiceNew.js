...
//    viewConfig: null,    
	fields: [{
		...
		header:'型号主键', dataIndex:'trainTypeIDX', hidden:true, editor:{
		...
		header:i18n.JczlTrainService.trainNo, dataIndex:'trainNo', editor:{ minLength:1 , maxLength:20 , allowBlank: false},
		...
		header:'制造厂家主键', dataIndex:'makeFactoryIDX',hidden: true,  editor:{ 
			 ...
			 queryHql:"From GyjcFactory where fcID='C'", 
