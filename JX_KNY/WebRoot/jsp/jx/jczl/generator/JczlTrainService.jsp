...
<script language="javascript" src="<%=ctx%>/frame/resources/i18n/<%=browserLang %>/i18n-lang-JczlTrainServiceNewGenerator.js"></script>
...
<script language="javascript" src="<%=ctx %>/jsp/jx/jczl/generator/JczlTrainServiceNew.js"></script>
</head>
<body>
</body>
</html>
