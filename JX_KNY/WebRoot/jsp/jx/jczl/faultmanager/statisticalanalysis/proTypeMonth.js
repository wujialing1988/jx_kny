...
Ext.onReady(function(){
	...
	proTypeMonth.getCurrentMonth = function(args){
		...
		var MonthEndDay=new Date(currentYear,currentMonth,currentDate-1);
	...
	//					queryHql:"[degree]tream",
	            ...
	            items: [{	
		            ...
		            items:[{
							fieldLabel:"统计时间区间",
				            id:"month",initNow:false,
					    	xtype:'my97date', value: MonthStartDay,
					    	hiddenName: 'month',
					    	format: "Y-m-d",
	...
	//            columnWidth: 0.4, 
	//            items: [
	//        		{ fieldLabel:"检修工艺流程", hiddenName:'isDispatcher',
	...
	//					emptyText : '全部',
						...
						width: 150
	//					returnField: [{widgetId:"typeNameId",propertyName:"dictname"}]
			        }]  
	        },{
	            align:'center',	defaultType:'textfield', border:true, baseCls: "x-plain",layout:"form",
				labelWidth: 100,
	           ...
	           align:'center',	defaultType:'textfield', border:true, baseCls: "x-plain",layout:"form",
	            ...
	            items: [{ xtype:'button',text:"统计",width:60,
	        		handler:function(){
						...
						var url = getReportEffectivePath("/qualitycontrol/proTypeMonth.cpt&date=" + data.month +
						"&protype="+data.professionalTypeIDX+"&faulttype="+data.type+"&orgseq="+data.orgseq+"&orgid="+data.org+"&ctx="+ctx_v);
	//					window.open(url);
