		...
		form = defineFormPanel({
			...
			rows:[{
				...
				cols:[{
					...
					xtype: "Base_combo",
					business: 'partsRdpUnionDeviceSearch',
					fields:['partsNo','partsName'],
					fieldLabel: "配件",
					hiddenName: "partsNo", 
					...
					xtype: "Base_combo",
					business: 'partsRdpUnionDeviceSearch',
					fields:['unloadTrainTypeIdx','unloadTrainType'],
					hiddenName: "trainType",
					displayField: "unloadTrainType",
					queryHql: "2",
					editable: true,
					typeAhead : false,
					forceSelection: true,
					valueField: "unloadTrainTypeIdx",
					pageSize: 20, minListWidth: 200,
					fieldLabel: "下车车型"
				},{
					xtype: "Base_combo",
