...
<script language="javascript" src="<%=ctx %>/jsp/jx/pjjx/partsrdp/worktime/PartsRdpWorkTime.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/pjjx/partsrdp/worktime/PartsRdpSetWorkTime.js"></script>
<script type="text/javascript">
