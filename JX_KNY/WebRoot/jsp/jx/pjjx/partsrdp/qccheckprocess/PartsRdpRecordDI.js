    ...
    PartsRdpRecordDI.grid = new Ext.grid.EditorGridPanel({
		...
		colModel:new Ext.grid.ColumnModel([
	        new Ext.grid.RowNumberer(),
			{
	        	...
	        	sortable:false, dataIndex:'seqNo', header:'顺序号', width: 25
	        },{	
	        	sortable:false, dataIndex:'dataItemName', header:'数据项名称', width: 50
	        },{	
	        	sortable:false, dataIndex:'dataItemResult', header:'检测结果'
	        },{
	        	sortable:false, dataIndex:'isBlank', header:'是否必填', width: 25, renderer: function(v){
