...
Ext.onReady(function() {
	...
	MatInforList.grid = new Ext.yunda.Grid({
	    ...
	    tbar:null,
		fields: [{
			header:i18n.MatInforList.materialCode, dataIndex:'matCode'
		},{
			header:i18n.MatInforList.materialDescription, dataIndex:'matDesc', width: 200
		},{
			header:i18n.MatInforList.MeasureUnit, dataIndex:'unit', width: 60			
		},{
			header:i18n.MatInforList.expectUnitPrice, dataIndex:'price', width: 60	
		}],
		storeId: 'matCode',
		storeAutoLoad: true
	});
	...
	MatInforList.batchWin = new Ext.Window({
		title:i18n.MatInforList.addMaterial,
				...
				items:[
					{
						...
						items:[
							{
								xtype:"textfield", width:120, fieldLabel:i18n.MatInforList.materialCode, id:"matCode"
							}
						]
					},
					{
						...
						layout:"form", baseCls:"x-plain",
						items:[{
								xtype:"textfield", width:120, fieldLabel:i18n.MatInforList.materialDescription, id:"matDesc"
							}]
					},
					{
					...
					},
					{
						...
						items:[{
							...
							text:i18n.MatInforList.search, iconCls:"searchIcon", handler: function() {
					...
					},
					{
						...
						items:[{
								xtype:"button", width:40,
								text:i18n.MatInforList.reset, iconCls:"resetIcon", handler: function() {
		...
		buttonAlign: 'center',
		buttons: [{
			text:i18n.MatInforList.add, iconCls:'addIcon', handler: function() {
				MatInforList.submit();
			}	
		}, {
			text:i18n.MatInforList.close, iconCls:'closeIcon', handler: function() {
