...
<html>
	<head>
		...
		<script language="javascript" src="<%=ctx %>/jsp/jx/scdd/enforceplanSnaker/TrainEnforcePlanDetailw.js"></script>
		...
		<script language="javascript" src="<%=ctx %>/jsp/jx/scdd/enforceplanSnaker/TrainEnforcePlan_JWD.js"></script>
	</head>
	<body>
	</body>
</html>