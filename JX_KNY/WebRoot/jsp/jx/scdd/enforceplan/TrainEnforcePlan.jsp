...
<html>
	<head>
		...
		<script language="javascript">
			...
			var status_audited = <%=TrainEnforcePlan.STATUS_AUDITED%>;
			//计划状态
		...
		<script language="javascript" src="<%=ctx%>/jsp/jx/scdd/enforceplan/DominateSectionWidget.js"></script>
		<script language="javascript" src="<%=ctx %>/jsp/jx/scdd/enforceplan/TrainEnforcePlanDetailw.js"></script>
		...
		<script language="javascript" src="<%=ctx %>/jsp/jx/scdd/enforceplan/TrainEnforcePlan_JWD.js"></script>
	</head>
	<body>
	</body>
</html>