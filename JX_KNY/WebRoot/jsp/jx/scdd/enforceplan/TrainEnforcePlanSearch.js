...
PlanDetailSearchView.grid = new Ext.yunda.Grid({
    ...
    tbar: ['search',{
        	text:"打印", iconCls:"printerIcon", handler: function(){
		        ...
		        +"&planEndDate="+planEndDate+"&planEndDate_End="+planEndDate_End + "&vehicleType="+vehicleType
    ...
    fields: [{
        ...
        header:'配属局', dataIndex:'bName',hidden:true,editor:{  maxLength:50 }
    },{
        ...
        header:'计划入段日期', dataIndex:'planStartDate', xtype:'datecolumn', searcher:{xtype:'my97date', initNow:false}
    },{
        header:'计划离段日期', dataIndex:'planEndDate', xtype:'datecolumn', searcher:{xtype:'my97date', initNow:false}
    },{
...
//    查询表单中的参数的组装
    ...
    // 客货类型
    whereList.push({propName:"vehicleType", compare:Condition.EQ, propValue:vehicleType});
