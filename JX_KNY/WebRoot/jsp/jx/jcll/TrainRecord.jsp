...
<script language="javascript" src="<%=ctx %>/jsp/jx/jcll/TrainWorkPlanWorkRecord.js"></script> <!-- 检修记录单查询 -->

<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/repairbase/TrainTypeCombo.js"></script> 
<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/repairbase/TrainNoCombo.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/jcll/PartsFixUnloadList.js"></script> <!-- 上车下车配件JS -->
<script language="javascript" src="<%=ctx %>/jsp/jx/jcll/TrainRecordRdpPlan.js"></script> <!-- 机车检修作业计划详细信息展示 -->
<script language="javascript" src="<%=ctx%>/jsp/jx/jcll/TrainRecord.js"></script>
</head>
<body>
</body>
</html>
