...
<script language="javascript" src="<%=ctx %>/jsp/jx/jxgc/workhis/workplan/TrainWordCardView_CommHis.js"></script> <!-- 检修记录单显示界面信息JS -->
<script language="javascript" src="<%=ctx %>/jsp/jx/acceptance/TrainWorkPlanWorkRecord.js"></script> <!-- 检修记录单查询 -->

<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/repairbase/TrainTypeCombo.js"></script> 
<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/repairbase/TrainNoCombo.js"></script>
<script language="javascript" src="<%=ctx %>/jsp/jx/acceptance/PartsFixUnloadList.js"></script> <!-- 上车下车配件JS -->
<script language="javascript" src="<%=ctx%>/jsp/jx/acceptance/TrainRecordRdpPlan.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/acceptance/TrainAcceptanceWin.js"></script>
<script language="javascript" src="<%=ctx%>/jsp/jx/acceptance/TrainAcceptance.js"></script>
</head>
<body>
</body>
</html>
