 ...
 * 库位选择列表
 * 控件使用方法：
 * 1.在页面jsp中引入js文件:<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/pjwz/WarehouseLocationCombo.js"></script> 
 * 2.在表单页面js添加下例标签代码 
 * {id:自定义, xtype: 'WarehouseLocation_combo',hiddenName: 自定义,fieldLabel:自定义,
...
jx.js.component.pjwz.WarehouseLocation_combo = function(){
...
//	this.forceSelection = false;
	this.dataurl = ctx + '/warehouseLocation!pageListForCombo.action';//数据源路径
	this.fields = ["idx","locationID","locationName","wareHouseIDX","warehouseID","warehouseName"];//数据字段
	jx.js.component.pjwz.WarehouseLocation_combo.superclass.constructor.apply(this, arguments);
	
}
Ext.extend(jx.js.component.pjwz.WarehouseLocation_combo,Ext.form.ComboBox,{	
	 setStore : function(){		
...
Ext.reg('WarehouseLocation_combo', jx.js.component.pjwz.WarehouseLocation_combo);