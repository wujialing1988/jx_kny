 ...
 * 修程对应修次的选择列表
 * 控件使用方法：
 * 1.在页面jsp中引入js文件:<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/repairbase/RCRTCombo.js"></script> 
 * 2.在表单页面js添加下例标签代码 
 * {id:自定义, xtype: 'RCRT_combo',hiddenName: 自定义,fieldLabel:自定义,
...
jx.js.component.repairbase.RCRT_combo = function(){
	...
	this.dataurl = ctx + '/rCRT!pageListForRCRTCombo.action';//数据源路径
	this.fields = ["repairtimeIDX","repairtimeName"];//数据字段
	jx.js.component.repairbase.RCRT_combo.superclass.constructor.apply(this, arguments);
	
}
Ext.extend(jx.js.component.repairbase.RCRT_combo,Ext.form.ComboBox,{	
	 setStore : function(){		
...
Ext.reg('RCRT_combo', jx.js.component.repairbase.RCRT_combo);