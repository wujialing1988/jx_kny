 ...
 * 车型选择列表
 * 控件使用方法：
 * 1.在页面jsp中引入js文件:<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/repairbase/TrainTypeCombo.js"></script> 
 * 2.在表单页面js添加下例标签代码 
 * {id:自定义, xtype: 'TrainType_combo',hiddenName: 自定义,fieldLabel:自定义,
...
jx.js.component.repairbase.TrainType_combo = function(){
	...
	this.dataurl = ctx + '/trainType!pageListForTTCombo.action';//数据源路径
	this.fields = ["typeID","shortName"];//数据字段
	jx.js.component.repairbase.TrainType_combo.superclass.constructor.apply(this, arguments);
	
}
Ext.extend(jx.js.component.repairbase.TrainType_combo,Ext.form.ComboBox,{	
	 setStore : function(){		
...
Ext.reg('TrainType_combo', jx.js.component.repairbase.TrainType_combo);