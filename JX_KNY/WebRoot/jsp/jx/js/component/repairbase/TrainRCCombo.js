 ...
 * 车型对应修程的选择列表
 * 控件使用方法：
 * 1.在页面jsp中引入js文件:<script language="javascript" src="<%=ctx%>/jsp/jx/js/component/repairbase/TrainRCCombo.js"></script> 
 * 2.在表单页面js添加下例标签代码 
 * {id:自定义, xtype: 'TrainRC_combo',hiddenName: 自定义,fieldLabel:自定义,
...
jx.js.component.repairbase.TrainRC_combo = function(){
    ...
    this.emptyText = "";
    this.returnField;
    this.pageSize = 10;//设置分页,默认为10条记录分页
	...
	this.dataurl = ctx + '/trainRC!pageListForRCCombo.action';//数据源路径
	this.fields = ["xcID","xcName"];//数据字段
	jx.js.component.repairbase.TrainRC_combo.superclass.constructor.apply(this, arguments);
	
}
Ext.extend(jx.js.component.repairbase.TrainRC_combo,Ext.form.ComboBox,{	
	 setStore : function(){		
...
Ext.reg('TrainRC_combo', jx.js.component.repairbase.TrainRC_combo);