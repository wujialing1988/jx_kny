...
jx.js.component.scdd.Station_combo = function(){
	...
	jx.js.component.scdd.Station_combo.superclass.constructor.apply(this, arguments);
	
}
Ext.extend(jx.js.component.scdd.Station_combo,Ext.form.ComboBox,{		
	setStore : function(){
			this.store = new Ext.data.JsonStore({
				root:"root", totalProperty:"totalProperty", 
				url:ctx + '/tWTStation!pageListForCombo.action',				
				fields:this.fields
			});
			if(this.pageSize != 0){				
				this.store.load({
...
Ext.reg('Twt_StationCombo', jx.js.component.scdd.Station_combo);