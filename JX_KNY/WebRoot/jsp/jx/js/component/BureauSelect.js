BureauSelect_comboTree = function(){
	this.tree =  new Ext.tree.TreePanel({
	    loader : new Ext.tree.TreeLoader( {
	        dataUrl : ctx + '/omOrganizationSelect!bureauTree.action'
	    }),
	    ...
	    listeners: {
	        beforeload: function(node, e){	        	
	            this.tree.getLoader().dataUrl = ctx + '/omOrganizationSelect!bureauTree.action?queryHql='+this.queryHql;
	        },
	        scope:this
	    }
	});
    ...
    BureauSelect_comboTree.superclass.constructor.apply(this, arguments);
}

Ext.extend(BureauSelect_comboTree,Ext.form.ComboBox, {
    
    expand : function(){
    	var ts = this;
        BureauSelect_comboTree.superclass.expand.call(this);
...
Ext.reg('BureauSelect_comboTree', BureauSelect_comboTree);
