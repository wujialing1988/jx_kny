...
<%@page import="com.yunda.sb.inspect.record.entity.InspectRecord" %>
...
<html>
	...
	<title>设备巡检统计</title>
		...
		<script type="text/javascript">
			...
			/** 巡检结果 - 合格 */
			var CHECK_RESULT_HG = '<%= InspectRecord.CHECK_RESULT_HG %>';
			/** 巡检结果 - 不合格 */
			var CHECK_RESULT_BHG = '<%= InspectRecord.CHECK_RESULT_BHG %>';
		...
		<script type="text/javascript" src="InspectDispose.js"></script>
	</head>
	<body>
	</body>
</html>
