...
<title>设备主要信息</title>
	...
	<script type="text/javascript" src="<%=ctx %>/jsp/sb/base/js/ClassificationSelect.js"></script>
	...
	<script type="text/javascript" src="ep_loader.js"></script>
	<script type="text/javascript" src="AffiliatedEquipment.js"></script>
	<script type="text/javascript" src="EprimarySearchForm.js"></script>
	<script type="text/javascript" src="EquipmentPrimaryInfo.js"></script>
</head>
<body>
</body>
</html>