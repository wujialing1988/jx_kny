Ext.onReady(function() {
	...
	Ext.ns('RepairScopeImport');
	
	RepairScopeImport.win = new Ext.Window({
		title: '导入检修范围',
		...
		buttons:[{
			text: "导入", iconCls: "saveIcon", handler: function() {
				...
				form.submit({  
                	url: ctx+'/repairScope!importRepairScope.action',  
                	waitTitle:'请稍候',
               	 	waitMsg: '正在导入设备检修范围，请稍候...', 
               	 	method: 'POST',
               	    ...
               	    success: function(form, action) {
               	    	alertSuccess();
               	    	window.hide();
               	    	// Modeified by hetao on 2016-09-22 如果选择了设备类别树节点，则重新加载设备巡检标准列表
