...
import com.yunda.jx.common.homepage.Link;
import com.yunda.jx.common.homepage.SynSite;
import com.yunda.jx.common.homepage.SynSites;
...
public class JXHomePageConfig {
	/** 静态实例化对象 */
	@XmlTransient
	private static JXHomePageConfig instance = null;
	
	@XmlElement
	private SynSites synSites;
	
	private JXHomePageConfig(){}
	
	public static JXHomePageConfig getInstance(){
		if(instance == null)
			instance = JAXB.unmarshal(Thread.currentThread().getContextClassLoader().getResourceAsStream("/HomePage.xml"), JXHomePageConfig.class);	//new JXHomePageConfig();
		return instance;
	}
	/**
