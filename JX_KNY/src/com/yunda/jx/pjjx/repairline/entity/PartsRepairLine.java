...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：PartsRepairLine实体类, 数据表：配件检修流水线
 * <li>创建人：程梅
 * <li>创建日期：2015-10-16
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="PJJX_PARTS_REPAIR_LINE")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class PartsRepairLine implements java.io.Serializable{
	/* 使用默认序列版本ID */
