...
import com.yunda.jx.pjjx.base.wpdefine.manager.WPUnionTecManager;
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：WPUnionTec控制器, 作业流程所用工艺
 * <li>创建人：何涛
 * <li>创建日期：2014-11-19
 * <li>修改人: 
 * <li>修改日期：
...
public class WPUnionTecAction extends JXBaseAction<WPUnionTec, WPUnionTec, WPUnionTecManager>{
	/** 日志工具 */
	...
	public void save() throws JsonMappingException, IOException {
		Map<String, Object> map = new HashMap<String,Object>();
		try {
			WPUnionTec[] parts = JSONUtil.read(getRequest(), WPUnionTec[].class);
