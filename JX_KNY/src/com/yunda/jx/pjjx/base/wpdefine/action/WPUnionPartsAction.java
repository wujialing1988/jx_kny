...
import com.yunda.jx.pjjx.base.wpdefine.manager.WPUnionPartsManager;
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：WPUnionParts控制器, 作业流程适用配件
 * <li>创建人：何涛
 * <li>创建日期：2014-11-19
 * <li>修改人: 
 * <li>修改日期：
...
public class WPUnionPartsAction extends JXBaseAction<WPUnionParts, WPUnionParts, WPUnionPartsManager>{
	/** 日志工具 */
	...
	public void save() throws JsonMappingException, IOException {
		Map<String, Object> map = new HashMap<String,Object>();
		try {
			WPUnionParts[] parts = JSONUtil.read(getRequest(), WPUnionParts[].class);
