...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：WPNodeUnionRecordCard实体类, 数据表：作业节点所挂记录单
 * <li>创建人：何涛
 * <li>创建日期：2014-11-19
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="PJJX_WP_Node_Union_Record_Card")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class WPNodeUnionRecordCard implements java.io.Serializable{
	/* 使用默认序列版本ID */
