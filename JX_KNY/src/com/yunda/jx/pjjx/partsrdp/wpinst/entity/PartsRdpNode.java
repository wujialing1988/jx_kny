...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：PartsRdpNode实体类, 数据表：配件检修作业节点
 * <li>创建人：何涛
 * <li>创建日期：2014-12-05
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="PJJX_Parts_Rdp_Node")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class PartsRdpNode implements java.io.Serializable{
	/* 使用默认序列版本ID */
    ...
    @Transient
    private PartsRdp partsRdp;

	
    public PartsRdp getPartsRdp() {
        return partsRdp;
    }
    
    public void setPartsRdp(PartsRdp partsRdp) {
