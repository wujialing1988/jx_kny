...
public class PartsRdpRecordZljcBean implements java.io.Serializable {
        ...
        /* 数据项List */
        @Transient
        private List<PartsQRRecordResult> partsQRRecordResultList;
        ...
        public List<PartsQRRecordResult> getPartsQRRecordResultList() {
            return partsQRRecordResultList;
        }
        
        public void setPartsQRRecordResultList(List<PartsQRRecordResult> partsQRRecordResultList) {
            this.partsQRRecordResultList = partsQRRecordResultList;
        }
