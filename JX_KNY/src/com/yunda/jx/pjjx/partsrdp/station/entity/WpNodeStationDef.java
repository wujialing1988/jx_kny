package com.yunda.jx.pjjx.partsrdp.station.entity;
...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：WpNodeStationDef实体类, 数据表：关联作业工位定义
 * <li>创建人：程梅
 * <li>创建日期：2015-10-16
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="PJJX_WP_Node_Station_Def")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class WpNodeStationDef implements java.io.Serializable{
	/* 使用默认序列版本ID */
     ...
     * <li>修改日期：
     */
    public WpNodeStationDef(){
        super();
    }
    /**
     * 
     * <li>说明：查询流程节点关联作业工位定义列表时所用
     * <li>创建人：程梅
     * <li>创建日期：2015-10-17
     * <li>修改人： 
     * <li>修改日期：
     ...
     */
    public WpNodeStationDef(String idx,String workStationCode,String workStationName,String repairLineName){
        this.idx = idx ;
