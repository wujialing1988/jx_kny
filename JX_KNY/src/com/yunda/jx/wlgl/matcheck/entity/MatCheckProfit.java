...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：MatCheckProfit实体类, 数据表：物料盘盈处理
 * <li>创建人：刘晓斌
 * <li>创建日期：2014-10-08
 * <li>修改人:
 * <li>修改日期：
 ...
 */
@Entity
@Table(name = "WLGL_Mat_Check_Profit")
@JsonAutoDetect(fieldVisibility = Visibility.ANY, getterVisibility = Visibility.NONE)
public class MatCheckProfit implements java.io.Serializable {
	/** 使用默认序列版本ID */
