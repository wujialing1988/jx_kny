...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：PartsDismantleRegister实体类, 数据表：配件拆卸登记单
 * <li>创建人：程梅
 * <li>创建日期：2016-01-08
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="PJWZ_PARTS_DISMANTLE_REGISTER")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class PartsDismantleRegister implements java.io.Serializable{
	/* 使用默认序列版本ID */
