...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：PartsFixRegister实体类, 数据表：上车配件登记单
 * <li>创建人：程梅
 * <li>创建日期：2015-10-13
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="PJWZ_Parts_FIX_Register")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class PartsFixRegister implements java.io.Serializable{
	/* 使用默认序列版本ID */
    ...
    /** 过滤配件状态为true【良好】或是false【良好不在库】配置项*/
    public static final String IS_PARTS_STATUS_CONFIG = "ck.jxgc.PartsFixRegister.getPartsAccount";
	/* idx主键 */
