...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：视图PJWZ_PARTS_FIX_REGISTER_HIS实体类, 数据表：配件上车信息历史查询视图
 * <li>创建人：程梅
 * <li>创建日期：2016年1月21日
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="PJWZ_PARTS_FIX_REGISTER_HIS")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class PartsFixRegisterHis implements java.io.Serializable{
	/* 使用默认序列版本ID */
    ...
    /* 下车信息 */
    @Column(name="UNLOAD_TRAIN")
    private String unloadTrain;
    /* 是否新品 */
    ...
    public String getUnloadTrain() {
        return unloadTrain;
    }

    
    public void setUnloadTrain(String unloadTrain) {
