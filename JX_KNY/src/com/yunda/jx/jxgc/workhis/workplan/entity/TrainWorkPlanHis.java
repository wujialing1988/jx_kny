...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：视图JXGC_Train_Work_Plan_HIS实体类, 数据表：机车检修作业计划历史
 * <li>创建人：程梅
 * <li>创建日期：2015年8月17日
 * <li>修改人:
 * <li>修改日期：
 ...
 */
@Entity
@Table(name = "JXGC_Train_Work_Plan_HIS")
@JsonAutoDetect(fieldVisibility = Visibility.ANY, getterVisibility = Visibility.NONE)
public class TrainWorkPlanHis implements java.io.Serializable {
     ...
     * @param trainNo 车型 + 车号
     */
    public TrainWorkPlanHis(String idx, String trainNo) {
        super();
        this.idx = idx;
