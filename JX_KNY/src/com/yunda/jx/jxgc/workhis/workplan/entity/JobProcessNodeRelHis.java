...
/**
 * <li>标题: 机车检修管理信息系统
 * <li>说明：视图JXGC_JOB_PROCESS_NODE_REL_HIS实体类, 数据表：机车检修作业计划-前置节点历史
 * <li>创建人：程梅
 * <li>创建日期：2015年8月17日
 * <li>修改人:
 * <li>修改日期：
 ...
 */
@Entity
@Table(name = "JXGC_JOB_PROCESS_NODE_REL_HIS")
@JsonAutoDetect(fieldVisibility = Visibility.ANY, getterVisibility = Visibility.NONE)
public class JobProcessNodeRelHis implements java.io.Serializable {
     ...
     */
    public JobProcessNodeRelHis(String idx, 
                             String nodeIDX, 
                             String preNodeIDX, 
                             String seqClass, 
                             Double delayTime, 
