 ...
 * TODO 待删除
 * <li>标题: 机车检修管理信息系统
 * <li>说明: JobNodeProjectDef实体 数据表：关联检修项目
 * <li>创建人：何涛
 * <li>创建日期：2015-4-14
 * <li>修改人: 
 * <li>修改日期：
 ...
 */
@Entity
@Table(name="JXGC_JobNode_Project_Def")
@JsonAutoDetect(fieldVisibility=Visibility.ANY,getterVisibility=Visibility.NONE)
public class JobNodeProjectDef implements java.io.Serializable{
	/* 使用默认序列版本ID */
