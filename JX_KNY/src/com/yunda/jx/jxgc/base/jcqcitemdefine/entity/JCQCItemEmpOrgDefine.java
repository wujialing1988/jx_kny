...
/**
 * <li>标题: 机车配件检修管理信息系统
 * <li>说明: QCEmpOrg实体 数据表：质量检查范围
 * <li>创建人： 何涛
 * <li>创建日期： 2014-11-13 上午10:09:57
 * <li>修改人: 
 * <li>修改日期： 
 * <li>修改内容： 
 ...
 */
@Entity
@Table(name = "JXGC_JCQC_ITEM_EMP_ORG_DEFINE")
@JsonAutoDetect(fieldVisibility = Visibility.ANY, getterVisibility = Visibility.NONE)
public class JCQCItemEmpOrgDefine implements java.io.Serializable {
	/** 使用默认序列版本ID */
