...
public class JCQCItemEmpDefineAction extends JXBaseAction<JCQCItemEmpDefine, JCQCItemEmpDefine, JCQCItemEmpDefineManager>{
	/** 日志工具 */
	...
	public void save() throws JsonMappingException, IOException {
		...
		try {
			JCQCItemEmpDefine[] objects = (JCQCItemEmpDefine[])JSONUtil.read(getRequest(), JCQCItemEmpDefine[].class);
    ...
    public void queryPageList() throws JsonMappingException, IOException {
        ...
        try {
            ...
            // 查询实体
            JCQCItemEmpDefine objEntity = JSONUtil.read(searchJson, JCQCItemEmpDefine.class);
            SearchEntity<JCQCItemEmpDefine> searchEntity = new SearchEntity<JCQCItemEmpDefine>(objEntity, getStart(), getLimit(), getOrders());
