 ...
 */
@Entity
@Table(name = "V_JXGC_TRAIN_WORK_PLAN_BACK")
@JsonAutoDetect(fieldVisibility = Visibility.ANY, getterVisibility = Visibility.NONE)
public class VTrainWorkPlanBacksourcing implements java.io.Serializable {
    ...
    public void setUnRegisterNum(Integer unRegisterNum) {
