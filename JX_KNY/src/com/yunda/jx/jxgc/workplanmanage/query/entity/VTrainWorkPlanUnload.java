 ...
 */
@Entity
@Table(name = "V_JXGC_TRAIN_WORK_PLAN_UNLOAD")
@JsonAutoDetect(fieldVisibility = Visibility.ANY, getterVisibility = Visibility.NONE)
public class VTrainWorkPlanUnload implements java.io.Serializable {
    ...
    /**
     * @param uncheckedNum  设置总登记下车配件数量
     */
