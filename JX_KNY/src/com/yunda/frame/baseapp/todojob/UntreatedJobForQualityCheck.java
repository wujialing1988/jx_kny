 ...
 * 
 */
public class UntreatedJobForQualityCheck extends UnTreatedJobPermissionManager <TodoJob,TodoJob> implements IUntreatedJob {
    ...
    public TodoJob getJob(String operatorid) {        
        ...
        tdj.setJobType(FUNC_GDZLJC_KC_NAME);
        tdj.setJobText("待处理(" + count + ")");
        tdj.setJobUrl("/jsp/jx/jxgc/producttaskmanage/qualitychek/QCHandle.jsp?vehicleType=20");
        tdj.setJobNum(count + "");
        return tdj;
    }
