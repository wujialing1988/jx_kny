 ...
 *
 */
public class UntreatedJobForZBGLTP extends UnTreatedJobPermissionManager <TodoJob,TodoJob> implements IUntreatedJob {
    ...
    public TodoJob getJob(String operatorid) {
        if(!checkPermission(Long.parseLong(operatorid), FUNC_ZBTP_NAME))
            return null;
    ...
    private Integer[] getCount(long operatorid){
        ...
        return zbglTpManager.findZBGLTPOrZBGLHPCount(operatorid,ZbglTp.STATUS_DRAFT);
    }
}
