...
public class ZbglRdpDTO {
    ...
    /* jt6 是否有处理中的标示 true表示有（必须做范围活），false表示没 * */
    // @Transient
    // private Boolean isDoJt6Flag;
    /* jt6 是否在前N次任务单重中做过范围活 true表示有，false表示没（必须做范围活） * */
    // @Transient
    // private Boolean isDoNumFlag;
    /* 入段时间 * */
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "in_time")
    private Date inTime;
