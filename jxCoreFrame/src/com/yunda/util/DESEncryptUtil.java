...
{  
    ...
    {  
        ...
        String keyFilePath = "E:/yunda.key";  
        DESEncryptUtil.test(keyFilePath, null, operatorType);  
          
        /** 加密 */  
        operatorType = "encrypt";  
        String sourceFilePath = "E:/develop/workspace/JX_YoGa/src/dataSource.properties";  
        DESEncryptUtil.test(keyFilePath, sourceFilePath, operatorType);  
          
        /** 解密 */  
        operatorType = "decrypt";  
        sourceFilePath = "E:/develop/workspace/JX_YoGa/src/en_dataSource.properties";  
        //DESEncryptUtil.test(keyFilePath, sourceFilePath, operatorType);  
    }  
    /** 
     * <ul> 
